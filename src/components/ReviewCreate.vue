                ...
                <div class="card-body">
                    ...
                    <form id="review-form" @submit.prevent="submitReview">
                        <div class="form-group">
                            ...
                            <input type="number" id="ratinginput" name=" rating" min="1" max="10" required="required" class="form-control" v-model="rating"></div> 
                            <div class="form-group">
                                <label for="summaryinput">Summary Review</label> 
                                <textarea row="3" id="summaryinput" name="summary" required="required" class="form-control" v-model="summary"></textarea>
                            </div> 
    ...
    methods: {
        submitReview(){
            const myReview ={
                ...
                PlayerFK: this.$store.state.PlayerFK
            };
